import { getDocsDatabaseId, extractErrorMessage, queryDatabase } from "../shared/notion-client.js";
/**
...
function todayDateString(dateOverride) {
    if (dateOverride)
        return dateOverride;
    const now = new Date();
...
export async function executeScanBriefingFailures(input, notion) {

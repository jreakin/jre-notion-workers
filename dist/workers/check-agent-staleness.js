import { resolveTargetDatabaseId, getDeadLettersDatabaseId, extractErrorMessage, queryDatabase } from "../shared/notion-client.js";
...
export async function executeCheckAgentStaleness(input, notion) {
    try {
        const agentsToCheck = input.agent_names && input.agent_names.length > 0
